  ...
  render() {
    ...
    this.el.innerHTML = /*html*/ `
      <div class="relative my-5">
        ...
        <input class="block w-full p-4 pl-10 text-sm text-neutral-900 border border-neutral-300 rounded-lg bg-neutral-50 focus:ring-amber-500 focus:border-amber-500 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-neutral-50 dark:focus:ring-amber-500 dark:focus:border-amber-500" placeholder="Search OMDb" required>
